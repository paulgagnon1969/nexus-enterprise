...
# Get local IP for Expo Go connection
LOCAL_IP=$(ipconfig getifaddr en0 2>/dev/null || echo "localhost")

echo "[nexus-mobile] Starting Expo Go dev server"
echo "  API base:  $API_BASE"
echo "  Local IP:  $LOCAL_IP"
echo "  App dir:   $PWD"
echo
echo "┌─────────────────────────────────────────────────────┐"
echo "│  Connect your Samsung tablet:                       │"
echo "│  1. Open Expo Go app on tablet                      │"
echo "│  2. Scan the QR code below, OR                      │"
echo "│  3. Enter manually: exp://${LOCAL_IP}:8081          │"
echo "│                                                     │"
echo "│  Fast Refresh: saves auto-update the app!          │"
echo "└─────────────────────────────────────────────────────┘"
echo

# Build dependencies and start Expo for mobile (shows QR code)
EXPO_PUBLIC_API_BASE_URL="$API_BASE" npm run dev
