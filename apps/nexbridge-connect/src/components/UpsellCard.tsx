...
export const MODULE_INFO: Record<string, { moduleName: string; description: string; price: string }> = {
  NEXBRIDGE_ASSESS: {
    moduleName: "Video Assessment",
