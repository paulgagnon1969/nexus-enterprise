...
> **LEGACY (GCP)**: This document describes the pre-March 2026 Redis setup when NCC production ran on GCP. It is retained for posterity only and should not be used going forward.
