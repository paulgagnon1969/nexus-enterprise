...
> **58 modules. 7 functional areas. NexOP ~6–12% of revenue recovered. NexINT 72% → 95% operational integrity.**
...
The 58 CAMs below organize into four layers of the intent system:
...
```
  ...
  HR           —      —      —      —     —     —      —       —     =  0
             ───    ───    ───    ───   ───   ───    ───     ───
              8     12      8      8     4    10      6       1     = 57+1 portfolio
```

**Densest cells**: FIN-ACC (5), OPS-INTL (5), OPS-VIS (4), CLT-COLLAB (4), TECH-INTG (3), EST-ACC (3), TECH-VIS (2), TECH-INTL (2), TECH-AUTO (2), FIN-AUTO (2), FIN-INTL (2), FIN-VIS (2)
...
|--------|-------|-------|-------|--------|
| FIN-ACC-0001 | NexVERIFY — Multi-Source Expense Convergence | 85/100 | ~7.50% | draft |
| FIN-ACC-0002 | Zero-Loss Receipt Capture | 90/100 | ~1.65% | draft |
| FIN-ACC-0003 | Cross-Project Duplicate Expense Scanner | 78/100 | ~0.45% | validated |
| FIN-ACC-0004 | Client Rate Adjustment System | 78/100 | — | draft |
| FIN-ACC-0005 | Bidirectional Invoice Pricing Engine | 65/100 | ~0.15% | draft |
| FIN-AUTO-0001 | Inline Receipt OCR | 75/100 | ~0.37% | draft |
| FIN-AUTO-0002 | Transaction-to-Bill Auto-Posting | 80/100 | ~0.75% | draft |
| FIN-INTG-0001 | Living Membership — Modular Commerce | 75/100 | ~0.65% | draft |
| FIN-INTL-0002 | Smart Prescreen Learning Loop | 83/100 | ~0.60% | draft |
| FIN-INTL-0003 | NexPRICE — Regional Pricing Intelligence | 88/100 | ~0.24% | draft |
| FIN-SPD-0001 | Hybrid Receipt OCR Pipeline | 78/100 | — | draft |
| FIN-VIS-0001 | Purchase Reconciliation Audit Chain | 83/100 | ~0.66% | draft |
| FIN-VIS-0002 | Invoice Retail Transparency Display | 60/100 | ~0.12% | draft |

### Estimating (EST) — 8 CAMs | Module NexOP ~4.62%

| CAM ID | Title | Score | NexOP | Status |
|--------|-------|-------|-------|--------|
| EST-ACC-0001 | NexDupE — Cross-Project Duplicate Expense Detection | 80/100 | ~0.35% | draft |
| EST-ACC-0002 | NexCAD Enhanced Video Assessment | 93/100 | — | draft |
| **EST-ACC-0003** | **NexUNIT — Unit Price Discrimination Engine** | **83/100** | **~0.65%** | **draft** |
| EST-AUTO-0002 | NexPLAN — AI-Assisted Selections & Planning | 90/100 | ~0.60% | draft |
| EST-INTG-0001 | Multi-Provider BOM Pricing Pipeline | 80/100 | ~2.99% | draft |
| EST-INTL-0001 | NexBRIDGE Video Index & Re-scan | 80/100 | ~0.18% | draft |
| **EST-INTL-0002** | **ScanNEX Component Identity & Material Intelligence** | **90/100** | **~0.85%** | **draft** |
| EST-SPD-0001 | Redis Price List Caching | 73/100 | ~0.13% | draft |

### Operations (OPS) — 14 CAMs | Module NexOP ~5.01%

| CAM ID | Title | Score | NexOP | Status |
|--------|-------|-------|-------|--------|
| OPS-ACC-0001 | NEXI Capture — Other Category Disposition | 65/100 | ~0.08% | draft |
| OPS-AUTO-0001 | Group Task Cascading Completion | 65/100 | — | draft |
|| **OPS-AUTO-0002** | **NexBUY — Group Shopping Cart & Consolidated Purchase** | **83/100** | **~0.45%** | **draft** |
| OPS-COLLAB-0001 | Phantom Fleet — Personal Asset Sharing | 78/100 | ~0.39% | draft |
| OPS-INTG-0001 | NexFIND Receipt Bridge — Verified Suppliers | 75/100 | ~0.26% | draft |
| OPS-INTL-0001 | NexFIND — Supplier Intelligence Network | 88/100 | ~0.54% | draft |
| OPS-INTL-0002 | NexCART — Intelligent Materials Procurement | 88/100 | ~1.00% | draft |
| **OPS-INTL-0003** | **NexCBAML — Cost-Benefit Analysis Materials Logistics** | **95/100** | **~1.50%** | **draft** |
| **OPS-INTL-0004** | **NexPRINT — Receipt-Verified Product Intelligence** | **90/100** | **~0.80%** | **draft** |
|| **OPS-INTL-0005** | **NexAGG — Cross-Project Bulk Procurement Intelligence** | **93/100** | **—** | **draft** |
| OPS-VIS-0001a | Field Qty Discrepancy Pipeline | 70/100 | ~0.61% | draft |
| OPS-VIS-0001b | Intelligent Feature Discovery | 83/100 | — | draft |
| OPS-VIS-0002 | Urgency-Based Task Dashboard | 73/100 | ~0.27% | draft |
| OPS-VIS-0003 | Project & Tenant Scan/Assessment Hub | 80/100 | — | draft |

### Technology (TECH) — 13 CAMs | Module NexOP ~1.51%

| CAM ID | Title | Score | NexOP | Status |
|--------|-------|-------|-------|--------|
| TECH-ACC-0001 | Graceful Sync Fallback | 70/100 | ~0.08% | draft |
| TECH-AUTO-0001 | NexBRIDGE Distributed Compute Mesh | 93/100 | — | draft |
| TECH-AUTO-0002 | Secure Web Portal Campaigns — Reusable CNDA-Gated Distribution | 83/100 | — | draft |
| TECH-INTG-0001a | NexBRIDGE Modular Subscription | 85/100 | — | draft |
| TECH-INTG-0001b | NexCAD Precision Scan → CAD Pipeline | 90/100 | — | draft |
| TECH-INTG-0002 | NexPLAN Distributed Pipeline | 80/100 | — | draft |
| TECH-INTL-0001a | NexEXTRACT Adaptive Intelligence | 88/100 | — | draft |
| TECH-INTL-0001b | TUCKS Telemetry & KPI System | 83/100 | ~1.19% | draft |
| TECH-SPD-0003 | Smart Media Upload | 73/100 | ~0.24% | draft |
| TECH-SPD-0004 | NexBRIDGE Real-Time Update Push | 70/100 | — | draft |
| TECH-VIS-0001 | NexOP — Operating Percentage Metric | 88/100 | — | draft |
| TECH-VIS-0002 | NexINT — Operational Integrity Dashboard | 90/100 | — | draft |
| TECH-COLLAB-0002 | Session Mirror — Remote Dev Oversight from Any Device | 83/100 | — | validated |

### Client Relations (CLT)

| CAM ID | Title | Score | NexOP | Status |
|--------|-------|-------|-------|--------|
| **CLT-INTG-0001** | **NCC Sovereign Marketplace — The Integrated Contractor Economy** | **93/100** | — | **draft (flagship)** |
| CLT-INTL-0001 | NexFIT — Personalized Module Discovery & ROI Engine | 90/100 | — | draft |
| CLT-COLLAB-0001 | Client Tenant Tier — Acquisition Flywheel | 75/100 | — | draft (implemented) |
| CLT-COLLAB-0002 | Dual-User Portal Routing | 73/100 | ~0.15% | draft |
| CLT-COLLAB-0003 | Viral Document Sharing & Graduated Identity System | 88/100 | — | draft |
| CLT-COLLAB-0004 | CAM Portal Viral Referral System | 83/100 | — | draft |

### Compliance (CMP) — 3 CAMs | Module NexOP ~0.60%

| CAM ID | Title | Score | NexOP | Status |
|--------|-------|-------|-------|--------|
| CMP-AUTO-0001 | NexCheck — Site Compliance Kiosk | 85/100 | ~0.40% | draft |
| CMP-CMP-0001 | CNDA+ Gated Access System | 85/100 | — | draft |
| CMP-INTG-0001 | OSHA eCFR Auto-Sync | 83/100 | ~0.20% | draft |

---

## Top 10 CAMs by Score

1. **OPS-INTL-0003** NexCBAML — Cost-Benefit Analysis Materials Logistics — **95/100** ★ #1
2. **CLT-INTG-0001** NCC Sovereign Marketplace — **93/100** ★ Flagship
3. **EST-ACC-0002** NexCAD Enhanced Video Assessment — **93/100**
4. **TECH-AUTO-0001** NexBRIDGE Distributed Compute Mesh — **93/100**
5. **OPS-INTL-0005** NexAGG — Cross-Project Bulk Procurement Intelligence — **93/100** ★ New
6. **CLT-INTL-0001** NexFIT Module Discovery & ROI Engine — **90/100**
7. **EST-INTL-0002** ScanNEX Component Identity & Material Intelligence — **90/100** ★ New
8. **FIN-ACC-0002** Zero-Loss Receipt Capture — **90/100**
9. **EST-AUTO-0002** NexPLAN AI-Assisted Selections — **90/100**
10. **TECH-INTG-0001b** NexCAD Precision Scan → CAD — **90/100**
11. **TECH-VIS-0002** NexINT Operational Integrity Dashboard — **90/100**
12. **OPS-INTL-0004** NexPRINT Receipt-Verified Product Intelligence — **90/100** 
...
**Score**: 85/100 (U:9 V:9 D:8 Def:8) | **NexOP**: ~7.50% | Highest-impact CAM in the portfolio.
...
**Score**: 90/100 (U:9 V:10 D:9 Def:8) | **NexOP**: ~1.65% | Highest value score in the portfolio.
...
**Score**: 78/100 (U:7 V:8 D:9 Def:7) | **NexOP**: ~0.45% | Status: validated.
...
**Score**: 78/100 (U:8 V:8 D:8 Def:7)
...
**Score**: 65/100 (U:6 V:7 D:8 Def:5) | **NexOP**: ~0.15%
...
**Score**: 75/100 (U:7 V:8 D:9 Def:6) | **NexOP**: ~0.37%
...
**Score**: 80/100 (U:8 V:9 D:8 Def:7) | **NexOP**: ~0.75%
...
**Score**: 75/100 (U:8 V:8 D:8 Def:6) | **NexOP**: ~0.65%
...
**Score**: 83/100 (U:8 V:9 D:9 Def:7) | **NexOP**: ~0.60%
...
**Score**: 88/100 (U:9 V:9 D:8 Def:9) | **NexOP**: ~0.24% direct + ~2.25% bid accuracy
...
**Score**: 78/100 (U:8 V:7 D:9 Def:7)
...
**Score**: 83/100 (U:8 V:9 D:9 Def:7) | **NexOP**: ~0.66%
...
**Score**: 60/100 (U:5 V:7 D:8 Def:4) | **NexOP**: ~0.12%
...
**Score**: 80/100 (U:8 V:8 D:9 Def:7) | **NexOP**: ~0.35%
...
**Score**: 93/100 (U:10 V:9 D:9 Def:9) | Highest uniqueness score in the portfolio.
...
**Score**: 83/100 (U:9 V:9 D:7 Def:8) | **NexOP**: ~0.65%
...
**Score**: 90/100 (U:9 V:9 D:10 Def:8) | **NexOP**: ~0.60% | Highest demonstrability score (10/10).
...
**Score**: 80/100 (U:8 V:9 D:9 Def:6) | **NexOP**: ~2.99% | #2 NexOP contributor.
...
**Score**: 80/100 (U:8 V:8 D:9 Def:7) | **NexOP**: ~0.18%
...
**Score**: 90/100 (U:9 V:10 D:9 Def:8) | **NexOP**: ~0.85% | Tied for highest value score (10/10).
...
**Score**: 73/100 (U:7 V:8 D:9 Def:5) | **NexOP**: ~0.13%
...
**Score**: 65/100 (U:6 V:7 D:8 Def:5) | **NexOP**: ~0.08%
...
**Score**: 65/100 (U:6 V:7 D:8 Def:5)
...
**Score**: 83/100 (U:8 V:9 D:9 Def:7) | **NexOP**: ~0.45%
...
**Score**: 78/100 (U:8 V:8 D:9 Def:6) | **NexOP**: ~0.39%
...
**Score**: 75/100 (U:8 V:7 D:8 Def:7) | **NexOP**: ~0.26%
...
**Score**: 88/100 (U:9 V:9 D:9 Def:8) | **NexOP**: ~0.54% | Strongest network-effect moat.
...
**Score**: 88/100 (U:9 V:10 D:8 Def:8) | **NexOP**: ~1.00% | Highest value score (10/10) tied with FIN-ACC-0002.
...
**Score**: 95/100 (U:10 V:10 D:9 Def:9) | **NexOP**: ~1.50% | Highest-scoring CAM in the portfolio.

→ [Full CAM](./OPS-INTL-0003-nexcbaml-cost-benefit-analysis-materials-logistics.md)

#### OPS-INTL-0004 — NexPRINT: Receipt-Verified Product Intelligence ★ New
*"Web descriptions lie. Receipts don't. Every purchase teaches the system what a product really is."*

**Problem**: Coverage extraction from retailer web scrapes is inherently unreliable — Amazon titles say "10 Bags" but the CBA prices per-bag instead of per-bundle, HD product dimensions are buried in inconsistent spec sheets, and no purchase history informs the next lookup. Every session starts from zero.
**NCC Advantage**: Receipt-verified learning loop that builds ProductFingerprint records from four ingestion paths (receipt OCR, HD Pro Xtra CSV, CBA web scraping, bank transaction confirmation). Seven-tier confidence hierarchy (VERIFIED → LOW) with daily cron drift detection. Fingerprints pre-empt the extraction pipeline — known products bypass all three tiers. Auto-syncs to CompanyPriceListItem with SKU and source vendor. The only system where buying a product makes every future purchase of that product more accurate.
**Score**: 90/100 (U:9 V:9 D:10 Def:8) | **NexOP**: ~0.80% | NexSTACK Layer 3.5 — the learning loop that makes Layers 1–4 self-improving. Rev 2.0: full mobile UI with confidence badges, price sparklines, and product intelligence sheet.

→ [Full CAM](./OPS-INTL-0004-nexprint-receipt-verified-product-intelligence.md)

#### OPS-INTL-0005 — NexAGG: Cross-Project Bulk Procurement Intelligence ★ New
*"Twenty jobs. Same metro. Same drywall. Nobody knew. NexAGG knows."*

**Problem**: A company runs 20+ active jobs in the same metro. Every project has approved PETLs with overlapping materials — drywall, insulation, lumber, trim. Each PM orders independently at retail. Nobody sees the aggregate volume or leverages organizational buying power.
**NCC Advantage**: Nightly scan of all tenant PETLs detects overlapping materials across geographic clusters (haversine < 50 miles). Threshold detection: ≥3 projects, ≥$5K aggregate value, ≥3 qualifying materials. Tiered savings estimation (5–15%). Branded email alerts to PMs, Admins, and Executives with stats cards and top materials. One-click conversion to NexBUY — creates per-project ShoppingCarts with project-specific quantities. NexSTACK Layer 5 — depends on all lower layers (NexCART, BOM Pricing, NexUNIT, NexPRINT, NexCBAML, NexBUY).
**Score**: 93/100 (U:10 V:9 D:9 Def:9) | NexSTACK Layer 5 — highest layer in the procurement stack. The first cross-project procurement intelligence system in construction PM.

→ [Full CAM](./OPS-INTL-0005-nexagg-cross-project-bulk-procurement-intelligence.md)
...
**Score**: 70/100 (U:7 V:8 D:8 Def:5) | **NexOP**: ~0.61%
...
**Score**: 83/100 (U:8 V:9 D:9 Def:7) | Revenue multiplier for every other module.
...
**Score**: 73/100 (U:7 V:8 D:9 Def:5) | **NexOP**: ~0.27%
...
**Score**: 80/100 (U:8 V:8 D:9 Def:7)
...
**Score**: 70/100 (U:6 V:9 D:7 Def:6) | **NexOP**: ~0.08%
...
**Score**: 93/100 (U:10 V:9 D:9 Def:9) | Tied for highest score in the portfolio.
...
**Score**: 83/100 (U:8 V:9 D:9 Def:7) | Generalizes CAM PIP infrastructure into a reusable platform.
...
**Score**: 85/100 (U:8 V:9 D:9 Def:8)
...
**Score**: 90/100 (U:9 V:9 D:9 Def:9)
...
**Score**: 80/100 (U:8 V:8 D:8 Def:8)
...
**Score**: 88/100 (U:9 V:9 D:8 Def:9)
...
**Score**: 83/100 (U:8 V:9 D:9 Def:7) | **NexOP**: ~1.19% | #3 NexOP contributor.
...
**Score**: 73/100 (U:7 V:7 D:8 Def:7) | **NexOP**: ~0.24%
...
**Score**: 70/100 (U:7 V:7 D:8 Def:6)
...
**Score**: 88/100 (U:9 V:9 D:9 Def:8)
...
*"Approve a deployment from the golf course. Reject a migration from the plane. Review a session from any laptop."*
...
**NCC Advantage**: Full-stack remote dev oversight via the NCC mobile app **and** the NCC web app. Live event streaming (WebSocket + REST fallback), push-notification-gated deployment approvals with Approve/Reject action buttons, inline commenting, and SUPER_ADMIN-only access enforced at every layer (API, WebSocket, mobile UI, web UI). Web Session Mirror at `/system/session-mirror` provides a two-column browser layout with full feature parity: session list, search, event feed, idle management, comments, and approval actions. No competitor in restoration or construction offers cross-platform command-and-control over AI-assisted development.
**Score**: 83/100 (U:9 V:8 D:9 Def:7) | Status: validated | Rev 1.3.
...
**Score**: 93/100 (U:10 V:10 D:8 Def:9) | Tied for highest score. Highest uniqueness + value in the portfolio.
...
**Score**: 90/100 (U:9 V:9 D:10 Def:8) | Highest demonstrability score (10/10) — live interactive wizard at `/nexfit`.
...
**Score**: 75/100 (U:7 V:8 D:9 Def:6) | Status: implemented.
...
**Score**: 73/100 (U:7 V:8 D:8 Def:6) | **NexOP**: ~0.15%
...
**Score**: 88/100 (U:9 V:9 D:9 Def:8) | Consumer-grade growth mechanics applied to B2B construction.
...
**Score**: 83/100 (U:8 V:9 D:8 Def:8) | Viral referral for IP-protected content.
...
**Score**: 85/100 (U:9 V:9 D:9 Def:7) | **NexOP**: ~0.40%
...
**Score**: 85/100 (U:8 V:9 D:9 Def:8) | IP protection via progressive compliance gates.
...
**Score**: 83/100 (U:8 V:9 D:9 Def:7) | **NexOP**: ~0.20%
...
| 1.1 | 2026-03-11 | Added CLT-INTG-0001 NCC Sovereign Marketplace (flagship CAM, 93/100) — 45 CAMs total |
| 1.2 | 2026-03-11 | Added CLT-INTL-0001 NexFIT Module Discovery & ROI Engine (90/100) — 46 CAMs total |
|| 1.3 | 2026-03-11 | Added CLT-COLLAB-0003 Viral Document Sharing & Graduated Identity (88/100) — 47 CAMs total |
|| 1.4 | 2026-03-11 | Added CLT-COLLAB-0004 CAM Portal Viral Referral (83/100) and CMP-CMP-0001 CNDA+ Gated Access (85/100) — 49 CAMs total |
|| 1.5 | 2026-03-13 | Added TECH-COLLAB-0002 Session Mirror — Remote Dev Oversight from Mobile (83/100) — 53 CAMs total |
|| 1.6 | 2026-03-13 | Added TECH-AUTO-0002 Secure Web Portal Campaigns (83/100) — 54 CAMs total |
||| 1.7 | 2026-03-14 | Added OPS-AUTO-0002 NexBUY — Group Shopping Cart & Consolidated Purchase (83/100) — 55 CAMs total |
...
||| 2.0 | 2026-03-15 | Added EST-ACC-0003 NexUNIT — Unit Price Discrimination Engine (83/100), NexSTACK Layer 3 — 56 CAMs total |
|| 2.1 | 2026-03-15 | Added OPS-INTL-0004 NexPRINT — Receipt-Verified Product Intelligence (88/100), NexSTACK Layer 3.5 — 57 CAMs total |
|| 2.2 | 2026-03-15 | Updated OPS-INTL-0004 NexPRINT to rev 2.0 (90/100) — HD Pro Xtra hook, bank confirmation, cost book sync, mobile UI (ConfidenceBadge, PriceSparkline, ProductIntelligenceSheet), Top 10 entry |
|| 2.3 | 2026-03-15 | Updated TECH-COLLAB-0002 Session Mirror to rev 1.3 — Web Session Mirror: two-column browser UI at /system/session-mirror with full mobile feature parity |
||| 2.4 | 2026-03-15 | Added OPS-INTL-0005 NexAGG — Cross-Project Bulk Procurement Intelligence (93/100), NexSTACK Layer 5 — 58 CAMs total. Migrated all scores from /40 to /100 base (each criterion 1–10, total = sum/40 × 100). |
